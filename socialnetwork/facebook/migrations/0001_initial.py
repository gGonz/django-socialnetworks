...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('facebook_facebookprofile', (
            ...
            ('service_uid', self.gf('django.db.models.fields.CharField')(max_length=80, unique=True, null=True, blank=True)),
    ...
    models = {
        ...
        'facebook.facebookprofile': {
            ...
            'service_uid': ('django.db.models.fields.CharField', [], {'max_length': '80', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
