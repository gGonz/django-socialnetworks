...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GitHubOAuthProfile'
        db.create_table(u'github_githuboauthprofile', (
        ...
        db.send_create_signal(u'github', ['GitHubOAuthProfile'])


    def backwards(self, orm):
        # Deleting model 'GitHubOAuthProfile'
        db.delete_table(u'github_githuboauthprofile')
    ...
    models = {
        ...
        u'github.githuboauthprofile': {
            'Meta': {'object_name': 'GitHubOAuthProfile'},
