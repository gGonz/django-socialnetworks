...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MovesAppOAuthProfile'
        db.create_table(u'moves_movesappoauthprofile', (
        ...
        db.send_create_signal(u'moves', ['MovesAppOAuthProfile'])


    def backwards(self, orm):
        # Deleting model 'MovesAppOAuthProfile'
        db.delete_table(u'moves_movesappoauthprofile')
    ...
    models = {
        ...
        u'moves.movesappoauthprofile': {
            'Meta': {'object_name': 'MovesAppOAuthProfile'},
