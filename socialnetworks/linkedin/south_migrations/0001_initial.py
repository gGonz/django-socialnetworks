...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkedInOAuthProfile'
        db.create_table(u'linkedin_linkedinoauthprofile', (
        ...
        db.send_create_signal(u'linkedin', ['LinkedInOAuthProfile'])


    def backwards(self, orm):
        # Deleting model 'LinkedInOAuthProfile'
        db.delete_table(u'linkedin_linkedinoauthprofile')
    ...
    models = {
        ...
        u'linkedin.linkedinoauthprofile': {
            'Meta': {'object_name': 'LinkedInOAuthProfile'},
