...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookOAuthProfile'
        db.create_table(u'facebook_facebookoauthprofile', (
        ...
        db.send_create_signal(u'facebook', ['FacebookOAuthProfile'])


    def backwards(self, orm):
        # Deleting model 'FacebookOAuthProfile'
        db.delete_table(u'facebook_facebookoauthprofile')
    ...
    models = {
        ...
        u'facebook.facebookoauthprofile': {
            'Meta': {'object_name': 'FacebookOAuthProfile'},
            ...
            'oauth_access_token_expires_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'oauth_refresh_token': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
