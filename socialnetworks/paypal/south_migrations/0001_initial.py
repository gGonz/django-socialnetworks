...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PayPalOAuthProfile'
        db.create_table(u'paypal_paypaloauthprofile', (
        ...
        db.send_create_signal(u'paypal', ['PayPalOAuthProfile'])


    def backwards(self, orm):
        # Deleting model 'PayPalOAuthProfile'
        db.delete_table(u'paypal_paypaloauthprofile')
    ...
    models = {
        ...
        u'paypal.paypaloauthprofile': {
            'Meta': {'object_name': 'PayPalOAuthProfile'},
