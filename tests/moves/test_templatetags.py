...
class MovesLoginButtonTestCase(TestCase):
    context = Context({})

    def test_default_values_renders_properly(self):
        template = Template(
            """{% load moves %}{% moves_login %}"""
        )
        ...
        self.assertHTMLEqual(
            rendered,
            """
            <form action="/social/moves/login/" method="post">
                <input type="hidden" name="next" value="" />
                <a class="" onclick="this.parentNode.submit()">
                    <i class=""></i><span>Sign in with Moves app</span>
                </a>
            </form>
            """
        )
    ...
    def test_custom_label_changes_button_text(self):
        template = Template(
            """{% load moves %}{% moves_login label="CUSTOM LABEL" %}"""
        )
    ...
    def test_custom_css_class_is_added(self):
        template = Template(
            """{% load moves %}{% moves_login css_class="CUSTOM" %}"""
        )
    ...
    def test_custom_icon_class_is_added(self):
        template = Template(
            """{% load moves %}{% moves_login icon_class="CUSTOM" %}"""
        )
        ...
        self.assertHTMLEqual(
            ...
            <form action="/social/moves/login/" method="post">
                <input type="hidden" name="next" value="" />
                <a class="" onclick="this.parentNode.submit()">
                    <i class="CUSTOM"></i><span>Sign in with Moves app</span>
                </a>
            </form>
            """
        )
    ...
    def test_only_login_changes_label(self):
        template = Template(
            """{% load moves %}{% moves_login only_login=True %}"""
        )
        ...
        self.assertHTMLEqual(
            ...
            <form action="/social/moves/login/" method="post">
                ...
                <input type="hidden" name="next" value="" />
                <a class="" onclick="this.parentNode.submit()">
                    <i class=""></i><span>Log in with Moves app</span>
                </a>
            </form>
            """
        )
    ...
    def test_reconnection_renders_hidden_input(self):
        template = Template(
            """{% load moves %}{% moves_login reconnection=True %}"""
        )
